...
![CI Status](https://github.com/qist/sftp/workflows/CI/badge.svg?branch=master&event=push) [![Go Reference](https://pkg.go.dev/badge/github.com/qist/sftp.svg)](https://pkg.go.dev/github.com/qist/sftp)

usage and examples
------------------

See [https://pkg.go.dev/github.com/qist/sftp](https://pkg.go.dev/github.com/qist/sftp) for
examples and usage.
